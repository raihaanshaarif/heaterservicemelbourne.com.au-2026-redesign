                ...
                {[
                  ...
                  <div key={i} style={{ display: "flex", gap: "12px", alignItems: "flex-start" }}>
                    <div style={{
                      ...
                      <i className={\`fas \${item.icon}\`} style={{ color: "#ef4444", fontSize: "16px" }}></i>
                    </div>
                    <span style={{
                      color: "#fff",
                      fontSize: "14px",
...
async function main() {
  ...
  console.log("🚀 Updating brand pages with Full Range & FAQs sections...\n");
  ...
  console.log(`   Total: ${updated + failed} / ${brands.length}`);
