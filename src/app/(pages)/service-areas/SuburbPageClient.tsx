...
const SuburbPageClient: React.FC<SuburbPageClientProps> = ({
  suburb,
  suburbSlug,
}) => {
  ...
  return (
    <>
      <DefaultBanner
        title={`Heating & Cooling Services in ${suburb}, Melbourne`}
        subTitle={`${suburb} Service Area`}
        titleLink={`/service-areas/${suburbSlug}`}
      />
                ...
                <div className="text-center mb-5">
                  ...
                  >
                    ...
                    >
                      ...
                      {suburb.toUpperCase()} HEATING &amp; COOLING
                    </span>
                  </motion.div>
                  ...
                  >
                    Professional Heating &amp; Cooling Services in {suburb}
                  </h1>
                  ...
                  >
                    ...
                    serving {suburb} and surrounding suburbs. For over 15 years,
                    we&apos;ve been helping {suburb} residents and businesses
                  ...
                  >
                    ...
                    ready to help {suburb} residents with same-day service and
                  ...
                  >
                    ...
                    Call for {suburb} Service: 0405 133 761
                  </motion.a>
                </div>
        ...
        <div className="container">
          ...
          >
            <motion.div className="text-center mb-5" variants={itemVariants}>
              ...
              >
                Our Complete Service Range in {suburb}
              </h2>
              <p
                style={{
                  fontSize: "1.05rem",
              ...
              >
                ...
                heating and cooling solutions for {suburb} residents and
                businesses.
              </p>
            </motion.div>
        ...
        <div className="container">
          ...
          >
            <motion.div className="col-lg-8">
              ...
              >
                Need Heating or Cooling Service in {suburb}?
              </h2>
              <p
                style={{
                  color: "#f3f4f6",
              ...
              >
                ...
                emergency breakdown, our team is ready to help {suburb}{" "}
                residents. With 24/7 availability and fast response times,
                we&apos;re your trusted local partner for all heating and
                cooling needs.
              </p>
            </motion.div>
        ...
        <div className="container">
          ...
          >
            <div className="text-center mb-5">
              ...
              >
                Common questions about our {suburb} heating and cooling services
              </p>
            </div>
            ...
            <div className="row">
              <div className="col-lg-8 mx-auto">
                {[
                  {
                    q: `Do you service the ${suburb} area?`,
                    a: `Yes, we proudly serve ${suburb} and all surrounding Melbourne suburbs. We have multiple dispatch locations to ensure fast response times.`,
                  },
                  {
                    q: `What's your response time for emergency calls in ${suburb}?`,
                    a: `We target a 4-hour response window for all emergency calls, including ${suburb}. For gas-related emergencies, we aim for 1-2 hours.`,
                  },
                  {
...
export default SuburbPageClient;
