...
const faqData = [
  {
    id: 1,
    question: "What is a gas ducted heating system?",
    answer:
      "A gas ducted heating system uses a central gas furnace to heat air, which is then distributed through a network of ducts to outlets in each room of your home. It provides whole-home heating from a single unit and can be zoned to control temperatures in different areas independently.",
  },
  {
    id: 2,
    question: "How energy efficient is gas ducted heating?",
    answer:
      "Modern gas ducted heating systems are rated between 5 and 7 stars, making them highly efficient compared to older units. A 6-star system can use up to 50% less gas than a 2-star unit. Regular servicing ensures your system maintains its rated efficiency over time.",
  },
  {
    id: 3,
    question: "How often should a gas ducted heater be serviced?",
    answer:
      "Annual servicing is strongly recommended. Before each winter is the ideal time. Servicing keeps your system operating safely, maintains efficiency, extends system life, and allows early detection of issues like heat exchanger cracks, which can cause carbon monoxide spillage.",
  },
  {
    id: 4,
    question: "What brands of gas ducted heaters do you work with?",
    answer:
      "We install, repair, service, and replace all major brands including Brivis, Rinnai, Braemar, Vulcan, Bonaire, Carrier, and Daikin. Our technicians carry service parts for the most common units and complete most jobs in a single visit.",
  },
  {
    id: 5,
    question: "How do I know if my gas ducted heater needs replacing?",
    answer:
      "Common signs include frequent breakdowns, uneven heating across rooms, high gas bills, the system being over 15 years old, or a failed heat exchanger. We provide honest assessments and will always advise repair if that is the better option for your situation.",
  },
  {
    id: 6,
    question: "Do you offer 24/7 emergency gas heater repair?",
    answer:
      "Yes. Our emergency gas ducted repair service operates 24 hours a day, 7 days a week, including weekends and public holidays. We aim to respond within 4 hours to emergency calls across all Melbourne suburbs.",
  },
  {
    id: 7,
    question:
      "Can gas ducted heating be zoned to heat different rooms independently?",
    answer:
      "Yes. Zone control systems allow you to divide your home into independently heated areas. Using motorised dampers and a zoning controller, you can set different temperatures in different zones and avoid heating rooms that are not in use, reducing your gas consumption.",
  },
  {
    id: 8,
    question: "Are gas ducted heating systems safe?",
    answer:
      "When properly installed and regularly serviced by a licensed gas fitter, gas ducted heating systems are very safe. Risk arises when systems are not maintained — particularly from cracked heat exchangers which can produce carbon monoxide. Annual servicing by a licensed technician is the most important safety measure.",
  },
  {
    id: 9,
    question: "How long does a gas ducted heating system last?",
    answer:
      "Well-maintained gas ducted heating systems typically last 15 to 20 years. Annual servicing significantly extends system life. When a major component such as the heat exchanger or control board fails on an older unit, replacement is generally more economical than repair.",
  },
  {
    id: 10,
...
const Page: React.FC = () => {
  ...
  return (
    <>
        ...
        <div className="container">
          ...
          >
            <motion.div className="col-lg-6" variants={itemVariants}>
              ...
              >
                From a full system installation or replacement to a 24/7
                emergency callout, our team is ready to help. Book online or
                call us now.
              </p>
      ...
      {/* SERVICES GRID */}
      <section
        className="services-one services-page py-5"
          ...
          >
            ...
            <h2 className="section-title__title">
              <TextAnimation animationStyle="style1">
                Complete Gas Ducted Heating <span>Services</span>
              </TextAnimation>
            </h2>
          </motion.div>
          <div className="row">
                  ...
                  <div className="services-one__img-box">
                    <div className="services-one__img">
                      <Image
                        ...
                        width={300}
                        height={250}
                        alt={`${service.title} – Gas Ducted Heating Melbourne`}
                      />
                    </div>
      ...
      <section
        className="py-5"
        style={{ backgroundColor: "#f4f5f9", borderTop: "1px solid #e6e6e6" }}
      >
        <div className="container">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            ...
            <h2 className="section-title__title">
              <TextAnimation animationStyle="style1">
                Why Melbourne Homes Trust <span>Our Team</span>
              </TextAnimation>
            </h2>
          </motion.div>
          <motion.div
          ...
          >
            {[
              ...
              },
              {
                ...
                desc: "Upfront pricing before any work begins. No hidden charges, no call-out surprises. We quote the job and that is what you pay.",
              },
              {
                icon: "fas fa-tools",
                title: "All Brands Serviced",
                desc: "Brivis, Rinnai, Braemar, Vulcan, Bonaire, Carrier, and more. Our vans are stocked with parts for the most common systems.",
              },
              {
                icon: "fas fa-phone",
                title: "24/7 Emergency Response",
                desc: "Gas heating failures do not keep business hours. Our emergency team operates around the clock, including weekends.",
              },
            ].map((item, i) => (
              <div key={i} className="col-md-3 col-sm-6">
                ...
                >
                  <motion.div
                    whileHover={{ y: -6 }}
                    className="p-4 bg-white rounded-4 h-100 text-center"
                    style={{
      ...
      <section className="py-5" style={{ backgroundColor: "#ffffff" }}>
        <div className="container">
          ...
          >
            ...
            <h2 className="section-title__title">
              <TextAnimation animationStyle="style1">
                Gas Ducted Heating <span>Questions Answered</span>
              </TextAnimation>
            </h2>
          </motion.div>
          <div className="row">
