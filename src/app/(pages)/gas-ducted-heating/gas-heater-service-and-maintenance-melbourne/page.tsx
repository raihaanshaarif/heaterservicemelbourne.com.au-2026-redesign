...
const faqData = [
  { id: 1, question: "How often should I service my gas ducted heating system?", answer: "We recommend an annual service before the winter season. Annual servicing ensures your system runs at peak efficiency, extends its working life, and keeps it safe. Gas appliances with cracked heat exchangers can produce carbon monoxide, making regular checks essential." },
  { id: 2, question: "What does a gas ducted heating service include?", answer: "Our comprehensive service includes heat exchanger inspection, burner cleaning, flue gas testing (CO and CO2 levels), filter replacement, thermostat calibration, gas pressure testing, zone damper checks, and a full safety assessment." },
  { id: 3, question: "How long does a service take?", answer: "A standard annual service takes approximately 60 to 90 minutes. If additional cleaning or minor repairs are required, this may extend slightly. We will let you know upfront if any additional work is needed before proceeding." },
  { id: 4, question: "Can a service prevent a breakdown?", answer: "Yes. The majority of gas ducted heating breakdowns are caused by issues that are identifiable and preventable during routine servicing, such as dirty burners reducing ignition reliability, failing thermocouples, and restricted filters causing overheating." },
  { id: 5, question: "When is the best time to book a service?", answer: "March to April (before winter) is the ideal time. We also service outside winter months and are less busy in summer. Booking early in the season avoids wait times and ensures your system is ready the moment temperatures drop." },
  { id: 6, question: "Do you service all brands of gas ducted heaters?", answer: "Yes. We service all major brands including Brivis, Rinnai, Braemar, Vulcan, Bonaire, Carrier, and Daikin. Our technicians carry service parts for the most common units and can complete most services in a single visit." },
  { id: 7, question: "Will the technician let me know if something needs repair?", answer: "Absolutely. If our technician identifies a fault or worn component during servicing, they will explain the issue clearly and provide an upfront repair quote before any additional work is carried out. There are no surprise charges." },
  { id: 8, question: "Is servicing required to maintain my warranty?", answer: "Many manufacturers require documented annual servicing to maintain the warranty on your gas ducted heating system. We provide a service report that can be kept with your warranty documents for this purpose." },
  { id: 9, question: "Do you service rental properties?", answer: "Yes. We provide gas ducted heating services for rental properties on behalf of landlords and property managers across all Melbourne suburbs. We can provide service reports and safety certificates for compliance purposes." },
  { id: 10, question: "What if my heater needs a repair during the service?", answer: "If we identify a fault during servicing, we will provide an upfront fixed-price quote. In most cases where common parts are required, we can carry out the repair on the same visit using parts from our fully stocked service van." },
];
            ...
            <motion.div className="col-lg-6" variants={itemVariants}>
              <div>
                ...
                <p className="text-secondary mb-4" style={{ fontSize: "1.1rem", lineHeight: "1.8" }}>
                  Keep your gas ducted heating system running safely and efficiently with an annual service from our licensed gas fitters. We carry out a comprehensive 20-point inspection and service on all major brands across all Melbourne suburbs.
                </p>
                <p className="text-secondary mb-5" style={{ fontSize: "1rem", lineHeight: "1.8" }}>
                  Book before winter for priority scheduling. Fixed-price servicing, fully stocked vans, and a written service report on every job.
                </p>
                ...
                <div className="d-flex gap-3 flex-wrap">
                  ...
                  <span className="px-3 py-2 rounded-2" style={{ backgroundColor: "#eff6ff", color: "#1e40af", fontSize: "0.85rem", fontWeight: 600 }}>&#10003; FIXED PRICE</span>
                  <span className="px-3 py-2 rounded-2" style={{ backgroundColor: "#f0f9ff", color: "#0369a1", fontSize: "0.85rem", fontWeight: 600 }}>&#10003; 20-POINT CHECK</span>
                </div>
              </div>
            </motion.div>
              ...
              <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={heroInView ? { opacity: 1, scale: 1 } : {}} transition={{ duration: 0.7, delay: 0.3 }} className="position-relative">
                ...
                <motion.div initial={{ opacity: 0, y: 10 }} animate={heroInView ? { opacity: 1, y: 0 } : {}} transition={{ delay: 0.5 }}
                  ...
                  <p className="mb-0 small">
                    <strong style={{ fontSize: "0.95rem" }}>Annual Service Specialists</strong><br />
                    <span style={{ fontSize: "0.85rem", opacity: 0.9 }}>2500+ systems serviced</span>
                  </p>
                </motion.div>
              </motion.div>
            </motion.div>
      ...
      <section className="stats-banner py-5" style={{ backgroundColor: "#f4f5f9", borderTop: "1px solid #e6e6e6", borderBottom: "1px solid #e6e6e6" }}>
        <div className="container">
          <div className="row gy-4">
            ...
            <StatCard icon="fas fa-tools" value={2500} suffix="+" label="Systems Serviced" />
            <StatCard icon="fas fa-star" value={4} suffix=".9" label="Star Rating" />
            <StatCard icon="fas fa-list-check" value={20} suffix="-point" label="Comprehensive Check" />
          </div>
        </div>
      </section>
              ...
              <div className="service-details__left">
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true, margin: "-100px" }}>
                  <div className="section-title text-left sec-title-animation animation-style1 mb-5">
                    <div className="section-title__tagline-box">
                      ...
                      <h6 className="section-title__tagline">Why Service Matters</h6>
                      <span className="section-title__tagline-border"></span>
                      <div className="section-title__shape-2"><i className="fas fa-flame"></i></div>
                    </div>
                    <h2 className="section-title__title">
                      <TextAnimation animationStyle="style1">Why Regular Gas Heater <span>Servicing Matters</span></TextAnimation>
                    </h2>
                  </div>
                  <p className="text-secondary mb-4" style={{ fontSize: "1.05rem", lineHeight: "1.8" }}>
                    Gas ducted heating systems require annual servicing to maintain safe and efficient operation. A cracked heat exchanger can allow combustion gases including carbon monoxide to enter your living spaces. Regular servicing catches these issues before they become dangerous or costly.
                  </p>
                  <p className="text-secondary" style={{ fontSize: "1.05rem", lineHeight: "1.8" }}>
                    <strong style={{ color: "#1a1a1a" }}>What makes us different:</strong> Our service is a genuine 20-point inspection and clean, not a short visual check. We test combustion gas quality, measure heat exchanger performance, calibrate your thermostat, and check all safety controls.
                  </p>
                </motion.div>
                ...
                <div className="my-5 py-5">
                  <div className="section-title text-left sec-title-animation animation-style1 mb-5 py-5">
                    ...
                    <h2 className="section-title__title">
                      <TextAnimation animationStyle="style1">What Our Gas Heater Service <span>Covers</span></TextAnimation>
                    </h2>
                  </div>
                  <motion.div initial="hidden" whileInView="visible" variants={containerVariants} viewport={{ once: true, margin: "-100px" }} className="row gy-4">
                    {[
                      { icon: "fas fa-wind", title: "Heat Exchanger Inspection", description: "We visually inspect and test the heat exchanger for cracks, corrosion, and carbon buildup. A compromised heat exchanger is the primary source of carbon monoxide spillage in gas ducted systems." },
                      { icon: "fas fa-smog", title: "Flue Gas Testing", description: "We analyse flue gas composition using calibrated instruments to measure CO and CO2 levels, verifying that combustion is clean and complete and that no dangerous gases are re-entering your home." },
                      { icon: "fas fa-filter", title: "Filter Cleaning and Replacement", description: "Dirty return air filters restrict airflow, causing the system to overheat and reducing efficiency. We clean or replace filters to restore full system airflow and extend heat exchanger life." },
                      { icon: "fas fa-sliders-h", title: "Thermostat Calibration", description: "We verify and calibrate your thermostat to ensure the displayed temperature matches actual room conditions, improving comfort and reducing unnecessary gas consumption from overshooting." },
                      { icon: "fas fa-network-wired", title: "Duct Sealing Check", description: "We inspect accessible duct connections and dampers for air leaks. Leaking ducts can waste 20 to 30% of your heated air before it reaches the rooms, significantly increasing your gas bills." },
                      { icon: "fas fa-tachometer-alt", title: "Gas Pressure Testing", description: "We verify gas inlet pressure is within the manufacturer's specified operating range. Incorrect gas pressure affects combustion quality and can cause ignition failures, short cycling, or unsafe operation." },
                    ].map((feature, index) => (
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true, margin: "-100px" }} className="my-5 py-5">
                  <div className="section-title text-left sec-title-animation animation-style1 mb-5 py-5">
                    ...
                    <h2 className="section-title__title">
                      <TextAnimation animationStyle="style1">What Happens During a <span>Service Visit</span></TextAnimation>
                    </h2>
                  </div>
                  <p className="text-secondary mb-4" style={{ fontSize: "1.05rem", lineHeight: "1.8" }}>
                    Our licensed gas fitter arrives at your scheduled time and carries out a systematic 20-point inspection of your entire gas ducted heating system. We test the system under operating conditions, clean key components, carry out any adjustments needed, and provide you with a written service report when complete.
                  </p>
                  <div className="p-4 rounded-3" style={{ backgroundColor: "#f4f5f9", borderLeft: "4px solid #fd5523" }}>
                    <strong style={{ color: "#fd5523", fontSize: "1rem" }}>
                      <i className="fas fa-lightbulb me-2" style={{ color: "#fd5523" }}></i>Our Commitment
                    </strong>
                    <p className="mb-0 mt-2 text-secondary" style={{ lineHeight: "1.7" }}>
                      If we identify any faults or worn components during the service, we explain the issue clearly and provide an upfront quote before any repair work begins. No pressure, no surprises.
                    </p>
                  </div>
                </motion.div>
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true, margin: "-100px" }} className="my-5 p-5 rounded-4" style={{ backgroundColor: "#f0f5fa", border: "1px solid #e0e8f0" }}>
                  <div className="section-title text-left sec-title-animation animation-style1 mb-5">
                    ...
                    <h2 className="section-title__title">
                      <TextAnimation animationStyle="style1">We Service All Melbourne <span>Suburbs</span></TextAnimation>
                    </h2>
                  </div>
                  <p className="text-secondary mb-0" style={{ fontSize: "1.05rem", lineHeight: "1.8" }}>
                    <strong style={{ color: "#1a1a1a" }}>We service all Melbourne suburbs</strong> for gas ducted heating maintenance, from inner city apartments to outer metropolitan homes. Our VBA licensed gas fitters travel to all areas of Greater Melbourne.
                  </p>
                  <div className="row gy-3 mt-4">
                    {[
                      { title: "All Melbourne Suburbs", sub: "Inner city, north, south, east, west" },
                      { title: "Priority Winter Booking", sub: "Book early for guaranteed pre-winter slots" },
                      { title: "Rental Property Service", sub: "Compliance reports for landlords available" },
                      { title: "All Brands Covered", sub: "Brivis, Rinnai, Braemar, Vulcan and more" },
                    ].map((item, i) => (
                      ...
                      <div className="col-xl-6">
                        <div className="faq-page__single">
                          <h4 className="fw-bolder mb-5 pb-4" style={{ color: "#062f3a", fontSize: "1.3rem", borderBottom: "2px solid #fd5523" }}>
                            <i className="fas fa-fire me-2" style={{ color: "#fd5523" }}></i>Servicing Questions
                          </h4>
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true, margin: "-100px" }}
                  ...
                  <p className="mb-5" style={{ fontSize: "1.1rem", color: "#d9e0eb", lineHeight: "1.7" }}>
                    Book before winter for priority scheduling. Our licensed gas fitters will have your system running safely and efficiently for the season ahead.
                  </p>
                  ...
                  <p className="mt-5 mb-0" style={{ fontSize: "0.9rem", color: "#a8b8cc", letterSpacing: "0.5px" }}>
                    &#10003; ALL MELBOURNE SUBURBS &bull; &#10003; VBA LICENSED &bull; &#10003; FIXED PRICE &bull; &#10003; 20-POINT CHECK
                  </p>
                </motion.div>
