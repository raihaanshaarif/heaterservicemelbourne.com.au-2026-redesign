...
const faqData = [
  {
    id: 1,
    question: "How do I know if my hydronic system has a hidden leak?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Not in most cases. We isolate the affected radiator or circuit using thermostatic valves and lockshield valves before carrying out the repair. For radiator connection leaks, we can typically isolate and repair a single radiator without draining the full system. Where a pipe run needs to be fully isolated, we use point isolation to minimise the drained volume.",
  },
  {
    id: 9,
    question: "Which Melbourne suburbs do you cover for hydronic leak repair?",
    answer:
      "We cover all Melbourne suburbs for hydronic leak detection and repair, including inner-city areas, and all northern, eastern, southeastern, southern, and western Melbourne suburbs. Slab leak investigations in properties with underfloor hydronic systems are covered across the full Melbourne metro area.",
  },
  {
    id: 10,
    question: "Will a hydronic leak repair affect the rest of my system?",
    answer:
    ...
    <>
      ...
      <JSONLDScript
        schema={generateServiceSchema(
          "Hydronic Leak Repair",
          "Expert hydronic heating system leak detection and repair services",
          "https://heaterservicemelbourne.com.au/emergency-services",
        )}
        id="hydronic-leak-schema"
      />
            ...
            <motion.div className="col-lg-6" variants={itemVariants}>
              <div>
                ...
                >
                  ...
                  >
                    <i className="fas fa-tint me-2"></i>HYDRONIC LEAK DETECTION
                    AND REPAIR
                  </span>
                </div>
                <h1
                ...
                >
                  Visible or hidden hydronic leak? Active drip, recurring
                  pressure loss, unexplained damp, or warm floor without
                  explanation? We locate every hydronic leak — above slab, below
                  slab, within the boiler — and carry out a lasting repair with
                  full pressure testing and system certification.
                </p>
                <div className="d-flex gap-3 mb-5 flex-wrap">
                  ...
                  >
                    ...
                    >
                      <i className="fas fa-phone me-2"></i> Call for Leak Repair
                      Now
                    </a>
                  </motion.div>
                  <motion.div
        ...
        <div className="container">
          <div className="row gy-4">
            <StatCard
              ...
              value={15}
              suffix="+ yrs"
              label="Hydronic Experience"
            />
            <StatCard
              icon="fas fa-tint-slash"
              value={2500}
              suffix="+"
              label="Hydronic Leaks Fixed"
            />
            <StatCard
              icon="fas fa-star"
              value={4}
              ...
              <div className="service-details__left">
                  ...
                  <div className="section-title text-left sec-title-animation animation-style1 mb-5">
                    ...
                    <h2 className="section-title__title">
                      <TextAnimation animationStyle="style1">
                        Every Type of Hydronic Leak{" "}
                        <span>Located and Repaired</span>
                      </TextAnimation>
                    </h2>
                  </div>
                  <p
                    ...
                    style={{ fontSize: "1.05rem", lineHeight: "1.8" }}
                  >
                    Hydronic leaks range from visible drips at accessible joints
                    to concealed losses beneath concrete slabs. Accurate
                    diagnosis determines the correct repair approach. We use
                    pressure testing, thermal imaging, and targeted moisture
                    detection to locate all leak types before any repair work
                    begins.
                  </p>
                </motion.div>
                    ...
                    {[
                      {
                        ...
                        title: "Radiator Joint and Connection Leak",
                        description:
                      ...
                      },
                      {
                        ...
                        title: "Concealed Slab Leak Detection",
                        description:
                      ...
                      },
                      {
                        ...
                        title: "Expansion Vessel and PRV Leak",
                        description:
                      ...
                      },
                      {
                        ...
                        title: "Post-Repair Pressure Test and System Check",
                        description:
                ...
                >
                  <div className="section-title text-left sec-title-animation animation-style1 mb-5 py-5">
                    ...
                    <h2 className="section-title__title">
                      <TextAnimation animationStyle="style1">
                        ...
                        <span>Before Any Repair Begins</span>
                      </TextAnimation>
                    </h2>
                  </div>
                  <div className="row gy-3 mb-4">
                    {[
                      ...
                      {
                        icon: "fas fa-tools",
                        title: "Circuit Isolation Testing",
                        description:
                  ...
                  >
                    <strong style={{ color: "#d32f2f", fontSize: "1rem" }}>
                      <i className="fas fa-ban me-2"></i>Do Not Use Chemical
                      Leak Sealants — They Cause Additional Damage
                    </strong>
                    <p
                      className="mb-0 mt-2 text-secondary"
                      style={{ lineHeight: "1.7" }}
                    >
                      Chemical sealants and stop-leak additives can block zone
                      valves, pump impellers, heat exchanger passages, and
                      expansion vessel connections — often causing significantly
                      more damage than the original leak. All hydronic leaks
                      should be repaired physically by a licensed technician.
                    </p>
                  </div>
                </motion.div>
                ...
                >
                  <div className="section-title text-center sec-title-animation animation-style1 mb-5">
                    ...
                    <h2 className="section-title__title">
                      <TextAnimation animationStyle="style1">
                        Hydronic Leak Repair Questions <span>Answered</span>
                      </TextAnimation>
                    </h2>
                  </div>
                  <div className="container">
      ...
      <ServiceAreasNearYou
        limit={12}
        title="Leak Repair Service Areas"
        subtitle="Expert leak detection and repair available across all Melbourne suburbs"
      />
    </>
  );
};
