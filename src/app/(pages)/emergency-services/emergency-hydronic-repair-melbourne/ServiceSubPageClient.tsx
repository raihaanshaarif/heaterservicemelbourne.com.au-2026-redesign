...
const faqData = [
  {
    id: 1,
    question: "What are the most common signs of a hydronic heating emergency?",
    answer:
  ...
  },
  {
    id: 2,
    question:
      "How quickly will you respond to a hydronic heating emergency in Melbourne?",
    answer:
  ...
  {
    id: 3,
    question: "Why does my hydronic boiler keep losing pressure?",
    answer:
  ...
  {
    id: 4,
    question: "Can you repair a hydronic system leak under a concrete slab?",
    answer:
      "Yes. Concealed slab leaks require specialist leak detection techniques to locate before any concrete needs to be disturbed. We use pressure testing and thermal imaging methods to map the exact leak location. We then discuss repair options with you — which may include direct access repair at the leak point or a section reroute above the slab — to minimise disruption to your property.",
  },
  {
    id: 5,
    question:
      "My hydronic zone valve is stuck — can this be repaired without draining the system?",
    answer:
  ...
  },
  {
    id: 6,
    question:
      "The boiler is running but some radiators are cold — is this a zone valve or pump fault?",
    answer:
      "This is typically either a stuck zone valve (preventing flow to specific zones), a circulation pump fault (if all zones are affected), air in the system causing localised flow blockage, or a failed thermostat signal not opening a zone valve. We test all these systematically to isolate the exact fault. In many cases a radiator that does not heat is caused by an airlock rather than a component failure and can be resolved quickly.",
  },
  {
    id: 7,
    question: "Which hydronic boiler brands do you service in emergencies?",
    answer:
      "We service all major hydronic boiler brands available in Melbourne including Bosch, Rinnai, Viessmann, Vaillant, Immergas, Worcester, Chromagen, Sime, and Navien. Our technicians carry parts for common fault scenarios across these brands and have access to next-day parts sourcing for less common components.",
  },
  {
    id: 8,
    question: "Is hydronic heating repair covered by home insurance?",
    answer:
      "This depends on your specific policy and the cause of the failure. Sudden accidental damage events — such as a pipe burst causing flooding — are often covered. Gradual wear or maintenance faults are less commonly covered. We can provide a detailed service report and compliance documentation to support an insurance claim if required.",
  },
  {
    id: 9,
    question:
      "Do I need to turn off the gas supply before calling for emergency hydronic repair?",
    answer:
      "If you smell gas alongside the heating fault, yes — turn off the gas at the meter and call the gas emergency line (1800 427 364) before calling us. If the fault is water leak or boiler shutdown only (no gas smell), you do not need to isolate the gas — but you should turn off the water supply to the hydronic system (at the boiler fill valve) if it is actively leaking water onto floors. If unsure, we can guide you through the correct isolation steps when you call.",
  },
  {
    id: 10,
    question:
      "Which Melbourne suburbs do you cover for emergency hydronic heating repairs?",
    answer:
      "We cover all Melbourne suburbs for emergency hydronic heating repair — inner city, northern, eastern, southeastern, southern, and western suburbs. Most areas are covered within a 4-hour response window. Our service area includes all Melbourne metro suburbs from Cranbourne and Frankston in the south to Sunbury and Whittlesea in the north.",
  },
];
    ...
    <>
      ...
      <JSONLDScript
        schema={generateServiceSchema(
          "Emergency Hydronic Repair",
          "24/7 emergency repair for hydronic heating systems and boiler breakdowns",
          "https://heaterservicemelbourne.com.au/emergency-services",
        )}
        id="emergency-hydronic-schema"
      />
        ...
        <div className="container">
          <div className="row gy-4">
            ...
            <StatCard
              ...
              value={4000}
              suffix="+"
              label="Hydronic Emergencies Fixed"
            />
          </div>
        </div>
      </section>
              ...
              <div className="service-details__left">
                  ...
                  <div className="section-title text-left sec-title-animation animation-style1 mb-5">
                    ...
                    <h2 className="section-title__title">
                      <TextAnimation animationStyle="style1">
                        Hydronic Heating Emergencies <span>We Respond To</span>
                      </TextAnimation>
                    </h2>
                  </div>
                  <p
                    ...
                    style={{ fontSize: "1.05rem", lineHeight: "1.8" }}
                  >
                    From complete boiler shutdown to active water leaks,
                    hydronic heating failures require fast, accurate diagnosis
                    and repair. Our technicians are trained on all major boiler
                    brands and carry the parts to resolve most faults in a
                    single visit.
                  </p>
                </motion.div>
                    ...
                    {[
                      {
                        ...
                        title: "Boiler Complete Failure",
                        description:
                          "Boiler shuts down and will not restart, producing no heat to any zone. We diagnose ignition failure, gas valve fault, heat exchanger fault, flue blockage, or control board failure — whatever the root cause — and carry out same-visit repair where possible.",
                      },
                      {
                        icon: "fas fa-tint",
                        title: "Hydronic Leak and Indoor Flooding",
                        description:
                          "Active water leak from boiler fittings, radiator connections, pipe joints, or underfloor pipes. We locate the exact leak source, isolate the circuit, and carry out a watertight repair. Concealed slab leaks are located using pressure testing and thermal detection methods.",
                      },
                      {
                        icon: "fas fa-sliders-h",
                        title: "Zone Valve Failure",
                        description:
                          "Stuck or failed zone valve preventing heat from reaching specific areas of the property. We test zone valve actuators and valve bodies, replace failed units, and verify that all relevant zones are receiving correct flow before completing the job.",
                      },
                      {
                        icon: "fas fa-fan",
                        title: "Circulation Pump Failure",
                        description:
                          "Failed hydronic pump causing no flow to any zone — producing a running boiler with cold radiators. We test pump voltage, impeller, and capacitor, and replace failed pumps with correctly sized replacements for your system configuration.",
                      },
                      {
                        icon: "fas fa-tachometer-alt",
                        title: "Pressure Loss",
                        description:
                          "Recurring system pressure loss below 1 bar preventing the boiler from operating. We identify the pressure source — expansion vessel failure, leaking PRV, system leak, or failed filling loop — and resolve the root cause so the system maintains stable operating pressure.",
                      },
                      {
                        icon: "fas fa-thermometer-empty",
                        title: "Radiator Not Heating",
                        description:
                          "Individual or multiple radiators not reaching temperature. Common causes include air in the system requiring bleeding, blocked zone valve, thermostatic radiator valve failure, or sludge buildup in the radiator body. We diagnose accurately and restore correct operation.",
                      },
                    ].map((feature, index) => (
                ...
                >
                    ...
                    {[
                      {
                        ...
                        suburbs:
                          "CBD, Fitzroy, Collingwood, Richmond, South Yarra, St Kilda",
                      },
                      {
                        icon: "fas fa-compass",
                        area: "Northern Suburbs",
                        suburbs:
                          "Brunswick, Northcote, Preston, Reservoir, Bundoora, Greensborough",
                      },
                      {
                        icon: "fas fa-compass",
                        area: "Eastern Suburbs",
                        suburbs:
                          "Hawthorn, Glen Waverley, Box Hill, Knox, Ringwood, Doncaster",
                      },
                      {
                        icon: "fas fa-compass",
                        area: "South-Eastern Suburbs",
                        suburbs:
                          "Oakleigh, Dandenong, Berwick, Cranbourne, Narre Warren, Frankston",
                      },
                      {
                        icon: "fas fa-compass",
                        area: "Southern Suburbs",
                        suburbs:
                          "Brighton, Bayside, Chelsea, Mentone, Moorabbin, Cheltenham",
                      },
                      {
                        icon: "fas fa-compass",
                  ...
                  >
                    <strong style={{ color: "#d32f2f", fontSize: "1rem" }}>
                      <i className="fas fa-certificate me-2"></i>All Major
                      Brands — Bosch, Rinnai, Viessmann, Vaillant, Immergas,
                      Worcester
                    </strong>
                    <p
                    ...
                    >
                      Our technicians are trained across all major hydronic
                      boiler brands. We carry parts for common fault scenarios
                      and have access to next-day parts sourcing for less common
                      components to minimise return visits.
                    </p>
                  </div>
                </motion.div>
                ...
                >
                  <div className="section-title text-center sec-title-animation animation-style1 mb-5">
                    ...
                    <h2 className="section-title__title">
                      <TextAnimation animationStyle="style1">
                        Hydronic Emergency Questions <span>Answered</span>
                      </TextAnimation>
                    </h2>
                  </div>
                  <div className="container">
