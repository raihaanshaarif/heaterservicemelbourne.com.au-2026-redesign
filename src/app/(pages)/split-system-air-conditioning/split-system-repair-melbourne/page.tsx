...
const faqData = [
  { id: 1, question: "Why is my split system not cooling or heating properly?", answer: "The most common causes are a dirty air filter restricting airflow, low refrigerant level from a leak, a faulty thermistor giving incorrect temperature readings, or a failed capacitor on the compressor. Our technician will diagnose the exact fault and provide a fixed-price repair quote." },
  { id: 2, question: "How much does a split system repair cost in Melbourne?", answer: "Repair costs depend on the specific fault and parts required. We provide a fully itemised, fixed-price quote after diagnostics before any work begins. Common repairs such as capacitor replacement, thermostat faults, and refrigerant recharging are carried out at flat rates with no hidden charges." },
  { id: 3, question: "Do you repair all brands of split systems?", answer: "Yes. We repair all major brands including Daikin, Mitsubishi Electric, Fujitsu, Panasonic, Samsung, Hitachi, LG, and Carrier. Our vans are stocked with common replacement parts to complete most repairs in a single visit." },
  { id: 4, question: "My split system is leaking water inside — what is causing it?", answer: "Indoor water leaks are usually caused by a blocked or disconnected condensate drain line, a dirty evaporator coil causing ice buildup that then melts, or incorrect unit tilt. We clear the drain and check the entire drainage system as part of the repair service." },
  { id: 5, question: "Can a split system be repaired if it is leaking refrigerant?", answer: "Yes. We locate the leak using electronic leak detection, repair the refrigerant circuit, pressure-test the system, and recharge with the correct refrigerant type to manufacturer specification. All refrigerant handling is performed by ARCtick licensed technicians." },
  { id: 6, question: "My split system is making a loud noise — should I be concerned?", answer: "Rattling or vibrating noises can indicate loose panels, a debris-blocked fan, or worn bearings. Hissing sounds often indicate a refrigerant leak. Grinding or squealing from the compressor is a serious fault. Do not ignore unusual noises — early diagnosis prevents more costly failures." },
  { id: 7, question: "How long does a split system repair take?", answer: "Most common faults are diagnosed and repaired within 1 to 2 hours. Complex faults requiring parts to be ordered may require a return visit. We always advise you of the timeline and parts availability before starting work." },
  { id: 8, question: "Do you provide a warranty on repairs?", answer: "Yes. All parts we supply carry manufacturer warranty and our labour is guaranteed. If the same fault recurs within the warranty period, we return and fix it at no additional charge." },
  { id: 9, question: "Should I repair or replace my split system?", answer: "If your unit is less than 8 to 10 years old and the repair cost is less than half the replacement cost, repair is generally the better option. For older units with compressor failure or multiple component faults, replacement often offers better long-term value. We provide honest advice either way." },
  { id: 10, question: "Do you repair split systems in rental properties?", answer: "Yes. We carry out split system repairs in rental properties across Melbourne on behalf of landlords and property managers. We provide written work reports for maintenance records and can provide compliance documentation where required." },
];
            ...
            <motion.div className="col-lg-6" variants={itemVariants}>
              <div>
                ...
                <p className="text-secondary mb-4" style={{ fontSize: "1.1rem", lineHeight: "1.8" }}>
                  Fast, reliable split system air conditioning repairs across all Melbourne suburbs. Our ARCtick licensed technicians diagnose and fix all faults — from refrigerant leaks and compressor issues to drainage problems and electrical faults — with same-day availability.
                </p>
                <p className="text-secondary mb-5" style={{ fontSize: "1rem", lineHeight: "1.8" }}>
                  Fixed-price quotes after diagnosis. Fully stocked service vans. Most repairs completed on the first visit.
                </p>
              ...
              <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={heroInView ? { opacity: 1, scale: 1 } : {}} transition={{ duration: 0.7, delay: 0.3 }} className="position-relative">
                ...
                <motion.div initial={{ opacity: 0, y: 10 }} animate={heroInView ? { opacity: 1, y: 0 } : {}} transition={{ delay: 0.5 }}
                  ...
                  <p className="mb-0 small">
                    ...
                    <span style={{ fontSize: "0.85rem", opacity: 0.9 }}>3500+ units repaired</span>
                  </p>
                </motion.div>
              </motion.div>
            </motion.div>
      ...
      <section className="stats-banner py-5" style={{ backgroundColor: "#f4f5f9", borderTop: "1px solid #e6e6e6", borderBottom: "1px solid #e6e6e6" }}>
        <div className="container">
          <div className="row gy-4">
            ...
            <StatCard icon="fas fa-wrench" value={3500} suffix="+" label="Units Repaired" />
              ...
              <div className="service-details__left">
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true, margin: "-100px" }}>
                  <div className="section-title text-left sec-title-animation animation-style1 mb-5">
                    ...
                    <h2 className="section-title__title">
                      <TextAnimation animationStyle="style1">Common Split System Faults <span>We Fix</span></TextAnimation>
                    </h2>
                  </div>
                  <p className="text-secondary mb-4" style={{ fontSize: "1.05rem", lineHeight: "1.8" }}>
                    Split system faults range from minor filter blockages to refrigerant circuit failures and compressor issues. Our technicians use electronic diagnostic tools to identify the root cause accurately and carry the most common replacement parts on every service van to complete repairs the same day.
                  </p>
                  <p className="text-secondary" style={{ fontSize: "1.05rem", lineHeight: "1.8" }}>
                    <strong style={{ color: "#1a1a1a" }}>Our commitment:</strong> Fixed-price quote after diagnosis, before any repair work starts. No surprises on the invoice.
                  </p>
                </motion.div>
                ...
                <div className="my-5 py-5">
                  <div className="section-title text-left sec-title-animation animation-style1 mb-5 py-5">
                    ...
                    <h2 className="section-title__title">
                      <TextAnimation animationStyle="style1">Split System Faults We <span>Diagnose and Repair</span></TextAnimation>
                    </h2>
                  </div>
                  <motion.div initial="hidden" whileInView="visible" variants={containerVariants} viewport={{ once: true, margin: "-100px" }} className="row gy-4">
                    {[
                      { icon: "fas fa-thermometer-empty", title: "Not Cooling or Not Heating", description: "The most common complaint — the unit runs but the room temperature does not change. Causes include low refrigerant, a failed capacitor, a dirty coil, or a faulty compressor. We diagnose the root cause and repair on the spot where possible." },
                      { icon: "fas fa-tint", title: "Water Leaking Indoors", description: "Indoor water leaks are caused by a blocked condensate drain, ice buildup from low refrigerant or a dirty coil, or an incorrectly pitched indoor unit. We clear the drain and inspect the full refrigerant circuit to prevent recurrence." },
                      { icon: "fas fa-wind", title: "Refrigerant Leak", description: "Loss of refrigerant causes reduced capacity, ice formation, and increased electricity consumption. We locate leaks using electronic detectors, repair the circuit, pressure-test, and recharge with the correct refrigerant type." },
                      { icon: "fas fa-volume-up", title: "Unusual Noises", description: "Rattling, hissing, grinding, or clicking sounds indicate specific mechanical or refrigerant faults. We identify the source — whether a loose fan blade, debris, worn bearing, or leaking refrigerant — and fix it correctly." },
                      { icon: "fas fa-bolt", title: "Electrical and Control Faults", description: "Tripping circuit breakers, error codes on the display, or unresponsive remote controls can point to PCB faults, capacitor failure, or wiring issues. We carry PCBs and capacitors for the most common models." },
                      { icon: "fas fa-sliders-h", title: "Poor Airflow", description: "Reduced airflow is usually caused by a heavily soiled filter or evaporator coil. Left unaddressed, it causes the coil to freeze and the compressor to overheat. We clean the unit and restore full airflow as part of the repair." },
                    ].map((feature, index) => (
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true, margin: "-100px" }} className="my-5 py-5">
                  <div className="section-title text-left sec-title-animation animation-style1 mb-5 py-5">
                    ...
                    <h2 className="section-title__title">
                      <TextAnimation animationStyle="style1">How Our Split System <span>Repair Process Works</span></TextAnimation>
                    </h2>
                  </div>
                  <p className="text-secondary mb-4" style={{ fontSize: "1.05rem", lineHeight: "1.8" }}>
                    Our technician arrives with a fully stocked service van and diagnostic equipment. We carry out a systematic inspection of both the indoor and outdoor units — checking refrigerant pressures, electrical components, airflow, and controls — before identifying the fault and quoting the repair.
                  </p>
                  <div className="p-4 rounded-3" style={{ backgroundColor: "#f4f5f9", borderLeft: "4px solid #fd5523" }}>
                    ...
                    <p className="mb-0 mt-2 text-secondary" style={{ lineHeight: "1.7" }}>
                      After diagnosis we explain the fault clearly and provide a fixed-price quote. We proceed only once you approve. No surprises on the invoice.
                    </p>
                  </div>
                </motion.div>
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true, margin: "-100px" }} className="my-5 p-5 rounded-4" style={{ backgroundColor: "#f0f5fa", border: "1px solid #e0e8f0" }}>
                  <div className="section-title text-left sec-title-animation animation-style1 mb-5">
                    ...
                    <h2 className="section-title__title">
                      <TextAnimation animationStyle="style1">Split System Repairs Across All <span>Melbourne Suburbs</span></TextAnimation>
                    </h2>
                  </div>
                  <p className="text-secondary mb-0" style={{ fontSize: "1.05rem", lineHeight: "1.8" }}>
                    <strong style={{ color: "#1a1a1a" }}>We repair split systems across all of Greater Melbourne</strong>, from inner-city apartments to outer suburban homes and commercial premises. Same-day availability in most areas during business hours.
                  </p>
                  <div className="row gy-3 mt-4">
                    {[
                      ...
                      { title: "Rental Property Repairs", sub: "Written work reports provided on request" },
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true, margin: "-100px" }} className="my-5 py-5">
                  <div className="section-title text-center sec-title-animation animation-style1 mb-5">
                    ...
                    <h2 className="section-title__title">
                      <TextAnimation animationStyle="style1">Split System Repair Questions <span>Answered</span></TextAnimation>
                    </h2>
                  </div>
                  <div className="container">
                    <div className="row">
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true, margin: "-100px" }}
                  ...
                  <h3 className="fw-bolder mb-4" style={{ fontSize: "2rem", color: "white", lineHeight: "1.3" }}>Split System Not Working?</h3>
                  <p className="mb-5" style={{ fontSize: "1.1rem", color: "#d9e0eb", lineHeight: "1.7" }}>
                    Book a same-day repair with our ARCtick licensed technicians. Fixed-price quotes after diagnosis. All Melbourne suburbs covered.
                  </p>
                  ...
                  <p className="mt-5 mb-0" style={{ fontSize: "0.9rem", color: "#a8b8cc", letterSpacing: "0.5px" }}>
                    &#10003; ALL MELBOURNE SUBURBS &bull; &#10003; ARCTICK LICENSED &bull; &#10003; SAME-DAY SERVICE &bull; &#10003; FIXED PRICE
                  </p>
                </motion.div>
