...
const BrivisBrandClient: React.FC = () => {
        ...
        <div className="container position-relative" style={{ zIndex: 2 }}>
          ...
          >
            <div className="col-lg-7">
              ...
              >
                Professional Brivis Heating Solutions Melbourne
              </motion.h1>
              ...
              >
                Expert installation, repair and maintenance for Brivis heating systems. Same-day service and 24/7 emergency support across Melbourne.
              </motion.p>
            ...
            {[
              {
                ...
                description:
                  "24/7 emergency repair service for Brivis heating systems. Fast response across all Melbourne suburbs.",
              },
              {
                icon: "fa-hammer",
            ...
            <div className="col-lg-6">
              ...
              >
                ...
                <ul style={{
                  ...
                  {["Evolution Series","SmartComfort Controller","Zone Plus"].map((product, i) => (
                    <li
                      key={i}
                      style={{
                        fontSize: "14px",
      ...
      >
        <div className="container">
          ...
          >
            ...
            >
              Brivis Heating Systems We Install & Service
            </motion.h2>
          </motion.div>
          ...
          >
            {[
              {
                title: "Brivis Gas Ducted Heating",
              ...
              {
                title: "Brivis Split System Heating",
          ...
          <div className="row">
            <div className="col-lg-8 offset-lg-2">
              ...
              >
                {[
                  {
                    q: "Which Brivis heating system is best for my home?",
                  ...
                  {
                    q: "Can I install Brivis hydronic heating in an existing home?",
                  ...
                  {
                    q: "How often should I service my Brivis heating system?",
                  ...
                  },
                  {
                    ...
                    a: "Absolutely! We offer 24/7 emergency heating repair service for all Brivis systems across Melbourne. Call 0405 133 761 for immediate assistance during winter heating emergencies.",
                  },
                  {
                    q: "Are your technicians licensed for heating installations?",
                    a: "Yes, all our technicians are fully licensed, insured, and factory-trained for Brivis heating systems. We guarantee genuine parts and professional workmanship with full warranty compliance.",
                  },
                  {
                    q: "What areas of Melbourne do you service?",
                    a: "We provide professional Brivis heating installation, repair, and maintenance throughout all Melbourne suburbs with same-day service available. Contact us for your specific location.",
                  },
                ].map((item, i) => (
                  <motion.div
                    key={i}
        ...
        <div className="container">
          ...
          >
            <h2 className="fw-bold" style={{
              ...
              Ready for Expert Brivis Heating?
            </h2>
...
export default BrivisBrandClient;
