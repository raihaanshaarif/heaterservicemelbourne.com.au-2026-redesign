...
const HitachiBrandClient: React.FC = () => {
        ...
        <div className="container position-relative" style={{ zIndex: 2 }}>
          ...
          >
            <div className="col-lg-7">
              ...
              >
                Professional Hitachi Heating Solutions Melbourne
              </motion.h1>
              ...
              >
                Expert installation, repair and maintenance for Hitachi heating systems. Same-day service and 24/7 emergency support across Melbourne.
              </motion.p>
            ...
            {[
              {
                ...
                description:
                  "24/7 emergency repair service for Hitachi heating systems. Fast response across all Melbourne suburbs.",
              },
              {
                icon: "fa-hammer",
        ...
        <div className="container">
          ...
          >
            <div className="col-lg-6">
              ...
              >
                <strong>Certifications & Recognition:</strong> Energy Star certified, Japanese top efficiency rated, Industrial proven
              </motion.p>
            ...
            <div className="col-lg-6">
              ...
              >
                ...
                <ul style={{
                  ...
                  {["Twin Rotary System","Advanced Inverter","RAS-AJ Series"].map((product, i) => (
                    <li
                      key={i}
                      style={{
                        fontSize: "14px",
      ...
      >
        <div className="container">
          ...
          >
            ...
            >
              Hitachi Heating Systems We Install & Service
            </motion.h2>
          </motion.div>
          ...
          >
            {[
              {
                title: "Hitachi Gas Ducted Heating",
              ...
              {
                title: "Hitachi Hydronic Heating",
              ...
              {
                title: "Hitachi Split System Heating",
          ...
          <div className="row">
            <div className="col-lg-8 offset-lg-2">
              ...
              >
                {[
                  {
                    q: "Which Hitachi heating system is best for my home?",
                  ...
                  {
                    q: "Can I install Hitachi hydronic heating in an existing home?",
                  ...
                  {
                    q: "How often should I service my Hitachi heating system?",
                  ...
                  },
                  {
                    ...
                    a: "Absolutely! We offer 24/7 emergency heating repair service for all Hitachi systems across Melbourne. Call 0405 133 761 for immediate assistance during winter heating emergencies.",
                  },
                  {
                    q: "Are your technicians licensed for heating installations?",
                    a: "Yes, all our technicians are fully licensed, insured, and factory-trained for Hitachi heating systems. We guarantee genuine parts and professional workmanship with full warranty compliance.",
                  },
                  {
                    q: "What areas of Melbourne do you service?",
                    a: "We provide professional Hitachi heating installation, repair, and maintenance throughout all Melbourne suburbs with same-day service available. Contact us for your specific location.",
                  },
                ].map((item, i) => (
                  <motion.div
                    key={i}
        ...
        <div className="container">
          ...
          >
            <h2 className="fw-bold" style={{
              ...
              Ready for Expert Hitachi Heating?
            </h2>
...
export default HitachiBrandClient;
