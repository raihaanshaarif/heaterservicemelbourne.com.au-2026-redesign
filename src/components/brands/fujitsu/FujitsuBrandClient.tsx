...
const FujitsuBrandClient: React.FC = () => {
        ...
        <div className="container position-relative" style={{ zIndex: 2 }}>
          ...
          >
            <div className="col-lg-7">
              ...
              >
                Professional Fujitsu Heating Solutions Melbourne
              </motion.h1>
              ...
              >
                Expert installation, repair and maintenance for Fujitsu heating systems. Same-day service and 24/7 emergency support across Melbourne.
              </motion.p>
            ...
            {[
              {
                ...
                description:
                  "24/7 emergency repair service for Fujitsu heating systems. Fast response across all Melbourne suburbs.",
              },
              {
                icon: "fa-hammer",
            ...
            <div className="col-lg-6">
              ...
              <motion.div variants={itemVariants} style={{ marginBottom: "28px" }}>
                <h4 style={{
                  ...
                  Highest SEER ratings in the industry for maximum efficiency
                </h4>
                <h4 style={{
                  color: "#b91c1c",
                  fontSize: "18px",
                  ...
                  <i className="fas fa-star" style={{ fontSize: "18px", fontFamily: "Font Awesome" }}></i>
                  Reliable compressor technology proven in extreme climates
                </h4>
              </motion.div>
              ...
              >
                <strong>Certifications & Recognition:</strong> Energy Star Certified, Hyper-Inverter technology, HVAC Industry Leader
              </motion.p>
            ...
            <div className="col-lg-6">
              ...
              >
                ...
                <ul style={{
                  ...
                  {["Halcyon Series","Professional Grade Compressor","EcoCool"].map((product, i) => (
                    <li
                      key={i}
                      style={{
                        fontSize: "14px",
      ...
      >
        <div className="container">
          ...
          >
            ...
            >
              Fujitsu Heating Systems We Install & Service
            </motion.h2>
          </motion.div>
          ...
          >
            {[
              {
                title: "Fujitsu Gas Ducted Heating",
              ...
              {
                title: "Fujitsu Hydronic Heating",
              ...
              {
                title: "Fujitsu Split System Heating",
          ...
          <div className="row">
            <div className="col-lg-8 offset-lg-2">
              ...
              >
                {[
                  {
                    q: "Which Fujitsu heating system is best for my home?",
                  ...
                  {
                    q: "Can I install Fujitsu hydronic heating in an existing home?",
                  ...
                  {
                    q: "How often should I service my Fujitsu heating system?",
                  ...
                  },
                  {
                    ...
                    a: "Absolutely! We offer 24/7 emergency heating repair service for all Fujitsu systems across Melbourne. Call 0405 133 761 for immediate assistance during winter heating emergencies.",
                  },
                  {
                    q: "Are your technicians licensed for heating installations?",
                    a: "Yes, all our technicians are fully licensed, insured, and factory-trained for Fujitsu heating systems. We guarantee genuine parts and professional workmanship with full warranty compliance.",
                  },
                  {
                    q: "What areas of Melbourne do you service?",
                    a: "We provide professional Fujitsu heating installation, repair, and maintenance throughout all Melbourne suburbs with same-day service available. Contact us for your specific location.",
                  },
                ].map((item, i) => (
                  <motion.div
                    key={i}
        ...
        <div className="container">
          ...
          >
            <h2 className="fw-bold" style={{
              ...
              Ready for Expert Fujitsu Heating?
            </h2>
...
export default FujitsuBrandClient;
