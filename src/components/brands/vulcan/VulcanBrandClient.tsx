...
const VulcanBrandClient: React.FC = () => {
        ...
        <div className="container position-relative" style={{ zIndex: 2 }}>
          ...
          >
            <div className="col-lg-7">
              ...
              >
                Professional Vulcan Heating Solutions Melbourne
              </motion.h1>
              ...
              >
                Expert installation, repair and maintenance for Vulcan heating systems. Same-day service and 24/7 emergency support across Melbourne.
              </motion.p>
            ...
            {[
              {
                ...
                description:
                  "24/7 emergency repair service for Vulcan heating systems. Fast response across all Melbourne suburbs.",
              },
              {
                icon: "fa-hammer",
        ...
        <div className="container">
          ...
          >
            <div className="col-lg-6">
              ...
              >
                Australian heating innovator with 40+ years in ductless systems
              </motion.h2>
              ...
              <motion.div variants={itemVariants} style={{ marginBottom: "28px" }}>
                <h4 style={{
                  ...
                  Specialized in ductless wall-mounted heating for flexibility
                </h4>
                <h4 style={{
                  color: "#b91c1c",
                  fontSize: "18px",
                  ...
                  <i className="fas fa-star" style={{ fontSize: "18px", fontFamily: "Font Awesome" }}></i>
                  QuickHeat technology reaches target temperature 20% faster
                </h4>
              </motion.div>
              ...
              >
                <strong>Certifications & Recognition:</strong> Australian Standard certified, Performance rated, Reliability proven
              </motion.p>
            ...
            <div className="col-lg-6">
              ...
              >
                ...
                <ul style={{
                  ...
                  {["QuickHeat","FlexiZone","Smart Controller"].map((product, i) => (
                    <li
                      key={i}
                      style={{
                        fontSize: "14px",
      ...
      >
        <div className="container">
          ...
          >
            ...
            >
              Vulcan Heating Systems We Install & Service
            </motion.h2>
          </motion.div>
          ...
          >
            {[
              {
                title: "Vulcan Gas Ducted Heating",
              ...
              {
                title: "Vulcan Split System Heating",
          ...
          <div className="row">
            <div className="col-lg-8 offset-lg-2">
              ...
              >
                {[
                  {
                    q: "Which Vulcan heating system is best for my home?",
                  ...
                  {
                    q: "Can I install Vulcan hydronic heating in an existing home?",
                  ...
                  {
                    q: "How often should I service my Vulcan heating system?",
                  ...
                  },
                  {
                    ...
                    a: "Absolutely! We offer 24/7 emergency heating repair service for all Vulcan systems across Melbourne. Call 0405 133 761 for immediate assistance during winter heating emergencies.",
                  },
                  {
                    q: "Are your technicians licensed for heating installations?",
                    a: "Yes, all our technicians are fully licensed, insured, and factory-trained for Vulcan heating systems. We guarantee genuine parts and professional workmanship with full warranty compliance.",
                  },
                  {
                    q: "What areas of Melbourne do you service?",
                    a: "We provide professional Vulcan heating installation, repair, and maintenance throughout all Melbourne suburbs with same-day service available. Contact us for your specific location.",
                  },
                ].map((item, i) => (
                  <motion.div
                    key={i}
        ...
        <div className="container">
          ...
          >
            <h2 className="fw-bold" style={{
              ...
              Ready for Expert Vulcan Heating?
            </h2>
...
export default VulcanBrandClient;
