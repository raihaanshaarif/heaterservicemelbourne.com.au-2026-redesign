...
const HaierBrandClient: React.FC = () => {
        ...
        <div className="container position-relative" style={{ zIndex: 2 }}>
          ...
          >
            <div className="col-lg-7">
              ...
              >
                Professional Haier Heating Solutions Melbourne
              </motion.h1>
              ...
              >
                Expert installation, repair and maintenance for Haier heating systems. Same-day service and 24/7 emergency support across Melbourne.
              </motion.p>
            ...
            {[
              {
                ...
                description:
                  "24/7 emergency repair service for Haier heating systems. Fast response across all Melbourne suburbs.",
              },
              {
                icon: "fa-hammer",
        ...
        <div className="container">
          ...
          >
            <div className="col-lg-6">
              ...
              >
                Chinese technology leader with 30+ years of heating innovation
              </motion.h2>
              ...
              >
                <strong>Certifications & Recognition:</strong> Energy Star certified, UL certified, Global warranty support
              </motion.p>
            ...
            <div className="col-lg-6">
              ...
              >
                ...
                <ul style={{
                  ...
                  {["Smart WiFi Series","EcoComfort","IoT Thermal Control"].map((product, i) => (
                    <li
                      key={i}
                      style={{
                        fontSize: "14px",
      ...
      >
        <div className="container">
          ...
          >
            ...
            >
              Haier Heating Systems We Install & Service
            </motion.h2>
          </motion.div>
          ...
          >
            {[
              {
                title: "Haier Gas Ducted Heating",
              ...
              {
                title: "Haier Split System Heating",
          ...
          <div className="row">
            <div className="col-lg-8 offset-lg-2">
              ...
              >
                {[
                  {
                    q: "Which Haier heating system is best for my home?",
                  ...
                  {
                    q: "Can I install Haier hydronic heating in an existing home?",
                  ...
                  {
                    q: "How often should I service my Haier heating system?",
                  ...
                  },
                  {
                    ...
                    a: "Absolutely! We offer 24/7 emergency heating repair service for all Haier systems across Melbourne. Call 0405 133 761 for immediate assistance during winter heating emergencies.",
                  },
                  {
                    q: "Are your technicians licensed for heating installations?",
                    a: "Yes, all our technicians are fully licensed, insured, and factory-trained for Haier heating systems. We guarantee genuine parts and professional workmanship with full warranty compliance.",
                  },
                  {
                    q: "What areas of Melbourne do you service?",
                    a: "We provide professional Haier heating installation, repair, and maintenance throughout all Melbourne suburbs with same-day service available. Contact us for your specific location.",
                  },
                ].map((item, i) => (
                  <motion.div
                    key={i}
        ...
        <div className="container">
          ...
          >
            <h2 className="fw-bold" style={{
              ...
              Ready for Expert Haier Heating?
            </h2>
...
export default HaierBrandClient;
