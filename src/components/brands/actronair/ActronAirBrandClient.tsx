...
const ActronAirBrandClient: React.FC = () => {
        ...
        <div className="container position-relative" style={{ zIndex: 2 }}>
          ...
          >
            <div className="col-lg-7">
              ...
              >
                Professional ActronAir Heating Solutions Melbourne
              </motion.h1>
              ...
              >
                Expert installation, repair and maintenance for ActronAir heating systems. Same-day service and 24/7 emergency support across Melbourne.
              </motion.p>
            ...
            {[
              {
                ...
                description:
                  "24/7 emergency repair service for ActronAir heating systems. Fast response across all Melbourne suburbs.",
              },
              {
                icon: "fa-hammer",
            ...
            <div className="col-lg-6">
              ...
              <motion.div variants={itemVariants} style={{ marginBottom: "28px" }}>
                <h4 style={{
                  ...
                  50 years of Australian HVAC expertise with local support
                </h4>
                <h4 style={{
                  color: "#b91c1c",
                  fontSize: "18px",
            ...
            <div className="col-lg-6">
              ...
              >
                ...
                <ul style={{
                  ...
                  {["SHX Series","Quantum Inverter","Zone Control Pro"].map((product, i) => (
                    <li
                      key={i}
                      style={{
                        fontSize: "14px",
      ...
      >
        <div className="container">
          ...
          >
            ...
            >
              ActronAir Heating Systems We Install & Service
            </motion.h2>
          </motion.div>
          ...
          >
            {[
              {
                title: "ActronAir Gas Ducted Heating",
              ...
              {
                title: "ActronAir Hydronic Heating",
              ...
              {
                title: "ActronAir Split System Heating",
          ...
          <div className="row">
            <div className="col-lg-8 offset-lg-2">
              ...
              >
                {[
                  {
                    q: "Which ActronAir heating system is best for my home?",
                  ...
                  {
                    q: "Can I install ActronAir hydronic heating in an existing home?",
                  ...
                  {
                    q: "How often should I service my ActronAir heating system?",
                  ...
                  },
                  {
                    ...
                    a: "Absolutely! We offer 24/7 emergency heating repair service for all ActronAir systems across Melbourne. Call 0405 133 761 for immediate assistance during winter heating emergencies.",
                  },
                  {
                    q: "Are your technicians licensed for heating installations?",
                    a: "Yes, all our technicians are fully licensed, insured, and factory-trained for ActronAir heating systems. We guarantee genuine parts and professional workmanship with full warranty compliance.",
                  },
                  {
                    q: "What areas of Melbourne do you service?",
                    a: "We provide professional ActronAir heating installation, repair, and maintenance throughout all Melbourne suburbs with same-day service available. Contact us for your specific location.",
                  },
                ].map((item, i) => (
                  <motion.div
                    key={i}
        ...
        <div className="container">
          ...
          >
            <h2 className="fw-bold" style={{
              ...
              Ready for Expert ActronAir Heating?
            </h2>
...
export default ActronAirBrandClient;
