            ...
            <div className="about-three__right">
              <FadeInAdvanced variant={"fadeInRight"} delay={300}>
                ...
                <p className="about-three__text">
                  There are many variations of passages available randomised
                  words which the majority have suffered alteration in some
                  form, by injected humour look page when looking at its layout
                ...
                <ul className="about-three__points-two list-unstyled">
                  ...
                  <li>
                    ...
                    <p>
                      Skilled Technicians Invest in a quality phone case to
                      protect device.
                    </p>
                  </li>
                </ul>
                <div className="about-three__btn-and-video">
                  ...
                  <div className="about-three__video-box">
                    ...
                    <p className="about-three__video-text">Watch Our Support</p>
                  </div>
                </div>
              </FadeInAdvanced>
            </div>
