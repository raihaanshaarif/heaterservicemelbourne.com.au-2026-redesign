            ...
            <div className="quote-tab">
              <div className="quote-tab__button">
                <ul className="tabs-button-box clearfix">
                  <li
                    className={`tab-btn-item ${activeTransport === "quote" ? "active-btn-item" : ""}`}
                    onClick={() => handleTransPort("quote")}
                  >
                  ...
                  <li
                    className={`tab-btn-item ${activeTransport === "track" ? "active-btn-item" : ""}`}
                    onClick={() => handleTransPort("track")}
                  >
                    <div className="quote-tab__button-inner">
                      <h3>Track & Trace</h3>
                    </div>
              ...
              <div className="tabs-content-box">
                {/*Start Tab*/}
                <div
                  className={`tab-content-box-item ${activeTransport === "quote" ? "tab-content-box-item-active" : ""}`}
                >
                  <QuoteTransportForm />
                </div>
                {/*End Tab*/}
                ...
                {/*Start Tab*/}
                <div
                  className={`tab-content-box-item ${activeTransport === "track" ? "tab-content-box-item-active" : ""}`}
                >
                  <TrackTransportForm />
                </div>
                {/*End Tab*/}
